...
filename = r'final_model.sav'
loaded_model = pickle.load(open(filename, 'rb'))
df = pd.read_csv(r"Clustered_Customer_Data.csv")
...
# Open Anaconda Command Promt
# use "cd" to change to file directory
# type "python app.py" and run the application
# it gives a warning. Next type "streamlit run app.py" and run the application
